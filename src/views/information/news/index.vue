<template>
  <div style="margin: 16px">
    ...
    <NewsModal @register="registerModal" @success="handleSuccess" :ifShowInfo="ifShowInfo" />
  </div>
</template>
<script lang="ts" setup>
  ...
  import { getNewsList, demoveNews } from '/@/api/information/news';
